...
public class MediaFlangeFunctions {
	...
	/*
	 * ("InputX3Pin10", IOTypes.BOOLEAN, 1); ("InputX3Pin16", IOTypes.BOOLEAN,
	 * 1); ("InputX3Pin13", IOTypes.BOOLEAN, 1); ("InputX3Pin3",
	 * IOTypes.BOOLEAN, 1); ("InputX3Pin4", IOTypes.BOOLEAN, 1);
	 */
