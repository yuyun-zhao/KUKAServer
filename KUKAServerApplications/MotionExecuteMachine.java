...
//	}
	...
	{
		Frame destination = LBR_Med_.getCurrentCartesianPosition(KUKAServerManager.tool_.getDefaultMotionFrame());
	...
	public static void LINMotionRelBase()
	{
		...
		Frame destination = LBR_Med_.getCurrentCartesianPosition(
